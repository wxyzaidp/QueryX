          ...
          <Card textAlign={'center'}>
            ...
            <ModalBody p="0px">
              <Text
                ...
                mb="22px"
              >
                You need a Google AI API Key to use this app's features. 
              ...
              <Flex mb="20px">
                ...
                <Button
                  ...
                  h="54px"
                  onClick={() => {
                    inputCode?.includes('AIza')
                      ? handleApiKeyChange(inputCode)
                      : null;
                    if (inputCode)
                      toast({
                        title: inputCode?.includes('AIza')
                        ...
                        position: 'top',
                        status: inputCode?.includes('AIza')
                          ? 'success'
                          : !inputCode?.includes('AIza')
                          ? `error`
                          : !inputCode
                  ...
                  <AccordionPanel p="18px 0px 10px 0px">
                    <UnorderedList p="5px">
                      ...
                      >
                        ...
                        and have generated a valid API key. We don't sell API keys.
                      </ListItem>
                      <ListItem
                        color={grayColor}
                        fontSize="md"
                        ...
                        fontWeight="500"
                      >
                        Make sure you've agreed to the terms of service in{' '}
                        <Link
                          textDecoration="underline"
                          fontSize="md"
                          lineHeight="28px"
                        ...
                        >
                          Google AI Studio
                        </Link>. Without accepting the terms, your API key will not work.
                      </ListItem>
                    </UnorderedList>
                  </AccordionPanel>
                </AccordionItem>
              ...
              <Text
                ...
                mx="30px"
              >
                *The app will connect to Google AI API server to check if your API Key is working properly.
              </Text>
            </ModalBody>
          </Card>
        </ModalContent>
